    ...
    <>
      <div className="container_head">
        <main className="main_header">
          <label className="label_inputSearch">
            <input className="inputSearch" type="text" id="imageInput" placeholder="Search for breeds by name"/>
          ...
          <Button className="btn_header"
                  ...
                  </svg>} padding="14px 16px"/>
            </Link>
          <Link to="/favorite">
            <Button className="btn_header"
                    icon={<svg xmlns="http://www.w3.org/2000/svg" width="30" height="26" viewBox="0 0 30 26"
                               fill="none">
                      <path fillRule="evenodd" clipRule="evenodd"
