...
const Breeds = () => {
  ...
  const breeds = ["All breeds", "Abyssinian", "Aegean"];
  ...
  const handleSortAscending = () => {
    const sorted = [...sortedBreeds].sort((a, b) => a.localeCompare(b)); // Сортування від A до Z
    setSortedBreeds(sorted);
  };

  const handleSortDescending = () => {
    const sorted = [...sortedBreeds].sort((a, b) => b.localeCompare(a)); // Сортування від Z до A
    setSortedBreeds(sorted);
  };
      ...
      <div className="container">
        ...
        <main className="main_breeds">
          <div className="btn_back">
            ...
            <button className="btn_sortByAlphabet" onClick={handleSortAscending}>
            ...
            <button className="btn_sortByAlphabet" onClick={handleSortDescending}>
